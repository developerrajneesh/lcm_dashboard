...
export default function LinkAdSet() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate("/user/meta-management/link/creative", {
        state: {
          ...campaignData,
  ...
  return (
    <div className="space-y-6">
      <button
        onClick={() => navigate("/user/meta-management/link/campaign")}
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Create Ad Set - Link Campaign</h1>
            <p className="text-gray-600 mt-1">Configure your ad set settings for the link campaign</p>
          </div>
        </div>
